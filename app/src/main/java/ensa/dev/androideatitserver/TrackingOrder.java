...
import ensa.dev.androideatitserver.Common.DirectionJSONParser;
import ensa.dev.androideatitserver.Model.Request;
import ensa.dev.androideatitserver.Remote.IGeoCoordinates;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED
            ...
            if(mLastLocation != null){
                ...
                //after Add Marker in your location, add Marker for this Order
    ...
    private class ParseTask extends AsyncTask<String,Integer,List<List<HashMap<String,String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... strings) {
            ...
            try{
                jObjet = new JSONObject(strings[0]);
                DirectionJSONParser parser = new DirectionJSONParser();

                routes = parser.parse(jObjet);
